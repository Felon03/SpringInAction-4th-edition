 ...
 * User: FreedomLy
 * Date: 2018-06-27 15:58
 * Description:
 */

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(classes = JdbcConfig.class)
//@ContextConfiguration(locations = "classpath:spittr/db/jdbc/JdbcRepositoryTest-context.xml")
public class JdbcSpittleRepositoryTest {
    ...
    public void findOne() {
        ...
        // 这里时间转换问题需要注意，java.util.Date和sql.Date的转换问题，需要getTimestamp来获取精确时间
        // 如果在{@link mapSpittle}中使用getTime()丢失时分秒，所以需要getTimestamp来获取准确的时间
    ...
    public void save() {
        ...
        Spittle spittle = new Spittle(null, spitter, "Un Nueo Spittle from art", new Date());
