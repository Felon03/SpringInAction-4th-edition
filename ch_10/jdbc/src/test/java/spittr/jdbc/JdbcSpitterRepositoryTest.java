...
public class JdbcSpitterRepositoryTest {
    ...
    private static void assertSpitter(int expectSpitterIndex, Spitter actual, String expectStatus) {
        Spitter expected = SPITTERS[expectSpitterIndex];
